...
<body>
	...
	<c:if test="${not empty sessionScope.usuario.admin}">
		<div class="panel panel-default" id="painel-login">
			...
			<div class="panel-heading">Cadastro Feriado</div>
			<div class="panel-body">
				<form action="calendario.do?op=cadastrarFeriado" method="post"
					class="form-horizontal">
					<div class="form-group" id="inputs-login">
						<textarea class="form-control" rows="4" cols="50" maxlength="80" name="descricao" placeholder="Descrição" required></textarea>
						<br> <input type="date"
