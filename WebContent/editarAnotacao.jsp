...
<body>
	...
	<c:if test="${empty sessionScope.usuario.admin and not empty sessionScope.usuario}">
		<div class="panel panel-default" id="painel-login">
			...
			<div class="panel-heading">Editar Anotação</div>
			<div class="panel-body">
				<form action="calendario.do?op=salvarAnotacao" method="post"
					class="form-horizontal">
					<div class="form-group" id="inputs-login">
						<textarea class="form-control" rows="4" cols="50" maxlength="80" name="mensagem"
						  required>${anotacao.mensagem}</textarea><br> 
						  Data atual: ${anotacao.data}
